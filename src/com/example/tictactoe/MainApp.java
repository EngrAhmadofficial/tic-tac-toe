...
// This file was moved to the standard Maven layout:
// src/main/java/com/example/tictactoe/MainApp.java
// Old copy retained as a placeholder to avoid duplicate class compilation in some IDEs.
...
public class MainApp extends Application {
    ...
    public void start(Stage stage) {
        ...
        restart.setOnAction(e -> reset(board));
    ...
    private void reset(Player[][] board) {
        this.board = new Player[3][3];
        current = Player.X;
        gameOver = false;
        // clear UI: rebuild stage quickly by restarting the app - simpler approach
